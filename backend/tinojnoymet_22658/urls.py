"""tinojnoymet_22658 URL Configuration
...
admin.site.site_header = "Tinojnoymet"
admin.site.site_title = "Tinojnoymet Admin Portal"
admin.site.index_title = "Tinojnoymet Admin"

# swagger
api_info = openapi.Info(
    title="Tinojnoymet API",
    default_version="v1",
    description="API documentation for Tinojnoymet App",
)
